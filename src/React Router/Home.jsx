...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* LINE 11 FIX: State is now correctly placed inside navigate() arguments */}
      <button onClick={() => navigate("/contact", { state: { email: "manideep@gmail.com", password: "123456789" } })}>
        pass the data to the Contact page
      </button>
